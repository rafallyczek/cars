package rafallyczek.cars.components;
...
public class CarsComponent extends JComponent implements ActionListener, KeyListener{
    ...
    public CarsComponent(){
        ...
        //Obrazy
        try{
            carSprite = ImageIO.read(CarsComponent.class.getResource("/images/car-sprite.png"));
            carObstacles = ImageIO.read(CarsComponent.class.getResource("/images/car-obstacles.png"));
            explosionSprite = ImageIO.read(CarsComponent.class.getResource("/images/explosion.png"));
        }catch(Exception ex){
            System.err.println("Błąd wczytywania zasobu: "+ex.toString());
        }
        
        //Dodanie utworów do listy
        mp3ResourceURL = CarsComponent.class.getResource("/sound/bensound-happyrock.mp3");
        mediaList.add(new Media(mp3ResourceURL.toString()));
        mp3ResourceURL = CarsComponent.class.getResource("/sound/bensound-punky.mp3");
        mediaList.add(new Media(mp3ResourceURL.toString()));
        musicCount = mediaList.size()-1;
        
        //Dźwięki
        URL soundURL = CarsComponent.class.getResource("/sound/engine.wav");
        engine = new AudioClip(soundURL.toString());
        engine.setCycleCount(AudioClip.INDEFINITE);
        soundURL = CarsComponent.class.getResource("/sound/explosion.wav");
